<x-app-layout>
    <div class="py-12 bg-[#FBFBFD] min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Header Section -->
            <div class="mb-10">
                <h2 class="text-4xl font-semibold text-gray-900 tracking-tight">Add New Product</h2>
                <p class="mt-2 text-lg text-gray-500 font-light">Configure details, specifications, customization forms, and pricing rules.</p>
            </div>
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-[2rem] border border-gray-100 p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" step="0.01" name="base_price" id="base_price" value="{{ old('base_price') }}" required 
                                   class="w-full bg-surface border border-border rounded-xl px-4 py-3 text-sm text-brand placeholder-muted focus:ring-1 focus:ring-accent focus:border-accent transition duration-300 outline-none">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    <input type="url" name="image_url" id="image_url" value="{{ old('image_url') }}" placeholder="External Image URL (e.g. /images/products/mug.png)"
                                           class="w-full bg-surface border border-border rounded-xl px-4 py-3 text-sm text-brand placeholder-muted focus:ring-1 focus:ring-accent focus:border-accent transition duration-300 outline-none">
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" required 
                                  class="w-full bg-surface border border-border rounded-xl px-4 py-3 text-sm text-brand placeholder-muted focus:ring-1 focus:ring-accent focus:border-accent transition duration-300 outline-none">{{ old('description') }}</textarea>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-[2rem] border border-gray-100 p-8 space-y-6"
                     x-data="{ specs: {{ json_encode(old('spec_keys') ? array_map(function($k, $v) { return ['key' => $k, 'value' => $v]; }, old('spec_keys'), old('spec_values')) : [['key' => 'Brand', 'value' => 'GiftStore Premium']]) }} }">
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-[2rem] border border-gray-100 p-8 space-y-6"
                     x-data="{ rules: {{ json_encode(old('rules') ?? []) }} }">
                    <div class="flex justify-between items-center border-b border-gray-100 pb-4">
